...
RegisterCommand("fps", function()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fps', {
		...
		if v == "reset" then
            ...
            ESX.ShowNotification('FPS setting changed to: Normal (Reset)')
        elseif v == "ulow" then
            ...
            ESX.ShowNotification('FPS setting changed to: Ultra Low')
        elseif v == "low" then
            RopeDrawShadowEnabled(false)
            ...
            ESX.ShowNotification('FPS setting changed to: Low')
        elseif v == "medium" then
            ...
            ESX.ShowNotification('FPS setting changed to: Medium')
		end
